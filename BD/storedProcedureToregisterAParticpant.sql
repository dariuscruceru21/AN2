...
CREATE PROCEDURE [dbo].[RegisterParticipantsForEvent]
    @ParticipantId INT,
    @LastName VARCHAR(50),
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN TRANSACTION
            ...
            VALUES (@EventId, @ParticipantId, GETDATE());

        -- Commit transaction
        COMMIT TRANSACTION

        -- Return success message and new ParticipantId
        SELECT 'Participant successfully registered' AS Message, @ParticipantId AS NewParticipantId;
